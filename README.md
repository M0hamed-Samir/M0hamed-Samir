# Salam 👋🏻, I'm Mohamed Samir

```
Frontend Developer @ EgyptAir | Angular & UI/UX
Computer Science graduate, ITI Front-end & UI/UX track.
Currently building aviation-domain frontend systems in production.
Open to connect — let's talk frontend, Angular, or design systems.
```
...
- **[ITI Admin Dashboard]** — *(coming soon)*: Admin dashboard built during ITI training — data management, role-based views.
